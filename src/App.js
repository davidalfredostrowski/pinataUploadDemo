...
function App() {
  ...
  const upload = async (e) => {
    ...
    try {
      ...
      // ===== OPTION A (proxy): just call /api/upload =====
      const url = "http://ec2-34-219-157-58.us-west-2.compute.amazonaws.com:3001/api/upload";

      // ===== OPTION B (direct URL + CORS): uncomment this instead =====
